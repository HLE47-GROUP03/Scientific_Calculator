...
#Σύμβολα/Ονόματα σύνθετων πράξεων.
tags_func=[ 'M-', 'MS', 'GT',
            'π','e','M+'       ,'MR'       ,'MC' ,
            'x^y', 'x^2' ,'sin'      ,'cos'      ,'tan',
            'log','ln' ,'arc\nsin' ,'arc\ncos' ,'arc\ntan',
...
#Κλήση αντίστοιχων συναρτήσεων για σύνθετες πράξεις.
...
#Σύμβολα απλών πράξεων και καθαρισμού οθόνης.
...
#Κλήση αντίστοιχων συναρτήσεων για απλές πράξεις.
...
#Δημιουργία κουμπιού εναλλαγής μοιρών ακτινίων.
...
#Δομές επανάληψης για την δημιουργία κουμπίων απεικόνισης σύνθετων πράξεων.
i=0
button_list=[]
...
#Δομή επανάληψης για την δημιουργία κουμπιών απλών πράξεων και αριθμών, όπου κάθε συνθήκη δίνει διαφορετικά χαρακτηριστικά σε κάθε κουμπί.
i=0
...
#Μήνυμα πληροφορίας για το κουμπί εναλλαγής μοιρών/ακτινίων.
Hovertip(switch_button, "Κλίκ για εναλλαγή υπολογισμού\n            μοιρών/ ακτινίων", hover_delay=100)

#Δομή επανάληψης για αντιστοίχιση κουμπιών και μηνυμάτων πληροφορίας.
