...
deg = PhotoImage(file = "C:/Users/melko/OneDrive/Documents/GitHub/Scientific_Calculator/Rad.png")
switch_button=tk.Button(frame, width=4, height=2, image=image_rad)
