...
is_deg=False                 # απο default, ξεκινάει με μοίρες
...
tags_func=[ 'rad','deg','M+'       ,'MR'       ,'MC' ,
            'x^y', 'e' ,'sin'      ,'cos'      ,'tan',
            'log','ln' ,'arc/nsin' ,'arc/ncos' ,'arc/ntan',
            '1/x','n!' ,'sinh'     ,'cosh'     ,'tanh',    
            'n√x','2√x','arc/nsinh','arc/ncosh','arc/ntanh'
               ]
...
rad = tk.PhotoImage(file = "C:/Users/melko/OneDrive/Documents/GitHub/Scientific_Calculator/Rad.png")
deg = tk.PhotoImage(file = "C:/Users/melko/OneDrive/Documents/GitHub/Scientific_Calculator/Deg.png")

switch_button=tk.Button(frame, width=4, height=10, image=rad, command=switch)
