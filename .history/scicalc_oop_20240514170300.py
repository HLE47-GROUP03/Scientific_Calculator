...
functions_2=[   '', '', '', calc.all_clear, '',
                ...
                calc.num_0, calc.comma, calc.num_00, '', calc.equal]
...
switch_button.grid(row=1, column=0, columnspan=2)switch_button.grid(row=1, column=0, columnspan=2, pady=5, padx=2, sticky="NSEW")
